const CONFIG = {
    ...
    subQuestion: "Pencet seng yes a zaa aje no",
    yesButton: "YES",
    noButton: "NO",
    noEscapeTexts: ["Nantang kw zaaaaa 😝", "Jijal manehh sayangg 😜", "Yawes lahh cukup tau tak yes na nyg! 💕"],
    ...
    flowerTitle: "Ambil zaaaa buat youu ",
    takeBouquetButton: "Terima hadiahnya ",
    bouquetMessage: "Lopyouuuuuuuuuuu 💕",
    nextFlowerButton: "Next ",
    collageTitle: "My Beautiful You",
    collageSubtitle: "Cantik bangettt sii pacar akuuuuu,Delokkk potoneee. Happy Valentine, my favorite person. 💕",
    nextCollageButton: "Satu halaman lagi… ",
    finalTitle: "Happy Valentine, My Love 💞",
    finalMessage: `Makasih ya sudah hadir dan bikin hariku selalu terasa cukup. Kamu adalah alasan kenapa senyum itu mudah muncul. Semoga hari harimu selalu penuh kehangatan dan kebahagiaan yaa Alizaaaaa💕. Aku selalu ada untukmu. Happy Valentine 💕`,
